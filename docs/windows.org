...
** Powershell
** 4NT
- Showing of line-endings in console might be tricky: with new-lines being interpreter as such, without carriage returns. Mostly for Babashka, with the Genie scripts it seems ok.
