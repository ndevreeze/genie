...
;; * the (babashka/tcl) client will then read these fields and write the contents on its
;;   dynamic vars *out* and *err* (or directly to stdout/stderr in Tcl)
;; * Babashka takes care that *out* and *err* are bound to the stdout/err of the client process.
