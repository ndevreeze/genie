...
;; test is command line options of script can conflict with cmdline options of the (babashka) client.
;; test with -p and -v

;; e.g. call with ../client/genie.clj -p 7889 ../test/test_params.clj -v -p 1234 abc
;; results in:
